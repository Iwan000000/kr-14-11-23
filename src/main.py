from hhru import HH_API
from vacancy import Vacancy
from superjobru import SuperJobAPI
from sort import sort_vacancies
    ...
    while True:
        ...
        if user_input == '1':
            ...
            for item in vacancies:
                ...
                user_save_input = input('Да - сохранить, Нет - не сохранять: ')

                if user_save_input.lower() == 'да':
            ...
            keyword = input('Введите ключевые слова: ')
            count = input('Введите количество вакансий: ')
            ...
            if user_check_vacancies.lower() != 'нет':
                jsonsaver = JsonSaver('file.txt')
                vacancies = jsonsaver.get_vacancies(keyword=user_check_vacancies.lower())
